...
def main():
    ...
    epoch_colors = {
        ...
        "mixed_ft_e1": "tab:orange",
        "mixed_ft_e2": "tab:green",
        "mixed_ft_e3": "tab:red",
        "mixed_ft_e25": "tab:purple",
    }
    ...
    fig.suptitle("t-SNE (PCA->50D) of web vs synthetic embeddings across epochs(mixed ratio 4:1)")
    plt.tight_layout()
    plt.savefig("./visualization/tsne_epochs_mixed0.8_color_split.png", dpi=300)
    plt.show()
