...
def main():
    ...
    epoch_colors = {
        ...
        "synth_ft_e1": "tab:orange",
        "synth_ft_e2": "tab:green",
        "synth_ft_e3": "tab:red",
        "synth_ft_e4": "tab:purple",
    }
    ...
    fig.suptitle("t-SNE (PCA->50D) of web vs synthetic embeddings across epochs(synth only)")
    plt.tight_layout()
    plt.savefig("./visualization/tsne_epochs_color_split.png", dpi=300)
    plt.show()
