...
# For PCA you can usually use more points,
# but subsampling still helps to keep things fast.
N_WEB_SAMPLES = 5000
N_SYN_SAMPLES = 5000
...
def main():
    ...
    plt.xlabel("PC 1")
    plt.ylabel("PC 2")
    plt.title("PCA (first 2 components) of image embeddings: real vs nowm")
    plt.tight_layout()
    plt.savefig("latent_pca_real_vs_nowm.png", dpi=300)
    plt.show()
