...
def main():
    ...
    model.print_trainable_parameters()  # Should list only LoR A A/B params (heads remain frozen)
    ...
    train_loader, val_loader = build_synth_dataloaders(
